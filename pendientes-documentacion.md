...
Este documento centraliza los apartados que todavía necesitan información adicional.

No sustituye las fichas específicas. Su finalidad es facilitar la revisión futura de la base de conocimiento.

## PRADO

### Títulos propios

La fuente indica que está pendiente:

- recibir el listado correspondiente desde la EIP;
- y completar la información prevista para el curso 2026/2027.
...
La fuente indica que este apartado está en elaboración.

Debe completarse:

- el procedimiento de creación;
- la responsabilidad de la EIP;
- las reglas de incorporación;
- y los casos de uso.
...
El árbol anterior estaba desactualizado.
...
### Categorías sin definición suficiente
...
Un apartado podrá considerarse documentado cuando incluya, como mínimo:
